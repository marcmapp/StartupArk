  ...
  const handleSaveAvailability = async () => {
    try {
      ...
      const response = await axios.put(
        `${baseUrl}/startupark/api/startupark/availability`,
        availabilityData,
        {
          headers: {
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1">
                  <select
                    ...
                    className="appearance-none border text-black border-gray-300 rounded-lg px-3 py-2 w-full text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                    disabled={loading}
                  >
