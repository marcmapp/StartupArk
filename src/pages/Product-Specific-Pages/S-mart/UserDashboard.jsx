  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (userRes.data.smartRole === 'startup' && !userRes.data.hasAgreedToSmartStartup) {
            ...
            <InfoCard title="Quick Actions" icon={BriefcaseIcon}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <QuickActionCard
                  ...
                  icon={EyeIcon}
                  action={() => navigate('/smart/startups')}
                  buttonText="Browse"
                />
                <QuickActionCard
                  ...
                  icon={HeartIcon}
                  action={() => navigate('/smart/saved-startups')}
            ...
            <InfoCard title="Recent Startups" icon={ClockIcon}>
              <div className="space-y-4">
                ...
                <div className="text-center pt-4">
                  <button
                    onClick={() => navigate('/smart/startups')}
          ...
          <div className="space-y-8">
            ...
            <InfoCard title="Quick Links" icon={ArrowRightIcon}>
              <div className="space-y-3">
                <button
                  onClick={() => navigate('/smart/startups?filter=trending')}
                ...
                <button
                  onClick={() => navigate('/smart/startups?filter=recent')}
                  className="w-full text-left p-3 rounded-lg border border-gray-200 hover:border-cyan-300 transition-colors duration-200"
                >
                ...
                <button
                  onClick={() => navigate('/smart/startups?filter=funding')}
                  className="w-full text-left p-3 rounded-lg border border-gray-200 hover:border-cyan-300 transition-colors duration-200"
                >
